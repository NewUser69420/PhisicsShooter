...
{        
    ...
    {        
        ...
        if (base.Owner.IsLocalClient)
        {
            ...
            if (GetComponent<ScoreTracker>().playerName == "" || GetComponent<ScoreTracker>().playerName == null)
            {
                Debug.Log("setting name on playerscore");
                GetComponent<ScoreTracker>().playerName = playerName;
            }
